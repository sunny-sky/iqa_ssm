                    ...
                    <div class="ibox-content">
                        <table class="table table-striped table-bordered table-hover " id="editable">
                            ...
                            <tbody>
                                ...
                                <c:forEach  items="${faqPicList}" var="a" varStatus="status">
	                                <tr class="gradeX">
	                                    ...
	                                    <td style="text-align: center;width: 5%">
	                                    	<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="删除" id = "${a.FAQPICTUREID}" onclick="deletePic(this.id)"><i class="fa fa-trash-o"></i></button>
	                                    </td>
	                                </tr> 
                                </c:forEach>
                    			<!-- </#list> -->
