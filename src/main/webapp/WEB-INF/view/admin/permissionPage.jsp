     ...
     <div class="ibox float-e-margins"> 
      ...
      <div class="ibox-content"> 
       ...
       <table class="table table-striped table-bordered table-hover dataTables-example"> 
        ...
        <tbody>
         <c:forEach  items="${permissionList}" var="a" varStatus="status">
         <tr class="gradeX" id=""> 
          ...
          <td style="text-align: center;width: 8%" id=""> 
          	<button class="btn btn-white btn-sm" type="button" id="${a.permissionId }" onclick="editPermission(this.id)" title="编辑" data-toggle="modal" data-target="#myModalEdit" ><i class="glyphicon glyphicon-pencil"></i></button> 
         ...
         <form class="form-horizontal m-t" method="post" action="add" > 
          <div class="modal-body"> 
           ...
           <div class="form-group"> 
            ...
            <div class="col-sm-8"> 
             <input id="addPhysicalName" name="addLogicName" type="text" class="form-control" aria-required="true" placeholder="请输入权限action描述" /> 
            </div> 
           </div> 
          </div> 
         ...
         <form class="form-horizontal m-t" id=""> 
          ...
          <div class="modal-body"> 
           ...
           <div class="form-group"> 
            <label class="col-sm-3 control-label">权限物理名：</label> 
            <div class="col-sm-8"> 
             <input id="editPhysicalName" name="logicName" type="text" class="form-control"  aria-required="true" /> 
            </div> 
           </div> 
          </div>
          <div class="modal-footer"> 
