	                    ...
	                    <div class="ibox-content" style="padding-bottom: 50px">
	                        <form method="get" class="form-horizontal">
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-10">
	                                    <p class="form-control-static">${UnResolvedEventDetail.userQuestionTitle}</p>
	                                </div>
	                            </div>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-10">
	                                    <p class="form-control-static">${UnResolvedEventDetail.userName}</p>
	                                </div>
	                            </div>
	                            <div class="hr-line-dashed"></div>
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-10">
	                                    <p class="form-control-static">${UnResolvedEventDetail.userQuestionTime}</p>
	                                </div>
	                            </div>
	                            <div class="hr-line-dashed"></div>                           
