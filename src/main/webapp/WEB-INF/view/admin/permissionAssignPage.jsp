        ...
        <div class="form-group"> 
         ...
         <div class="col-sm-10" style="width: 70%;margin-top: -5px;"> 
          <select class="form-control m-b" name="account" style="width: 70%;height: 32px" id="roleId" onchange="selectRole()"> 
           <!-- <#list roleList as a>  -->
           <c:forEach  items="${roleList}" var="a" varStatus="status">
       ...
       <div class="row" > 
        ...
        <div class="col-md-5" >         
         ...
         <table class="table table-striped table-bordered table-hover "> 
          ...
          <tbody id="tbody1">
           <c:forEach  items="${notObtainRolePermission}" var="p" varStatus="status">		   
	           <tr class="gradeX" id=""> 
        ...
        <div class="col-md-5" style="float: right;"> 
         ...
         <table class="table table-striped table-bordered table-hover "> 
          ...
          <tbody id="tbody2">
           <c:forEach  items="${obtainRolePermission}" var="obtain" varStatus="status">
	           <tr class="gradeX" id=""> 
