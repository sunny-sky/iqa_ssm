					...
					<div class="ibox-content" style="display:block;padding-bottom: 50px" id="subinfo" >
                      <form method="post" class="form-horizontal" >
                       <div class="form-group">
                           ...
                           <div class="col-sm-10">
                               <p class="form-control-static" >${resolvedEventDetail.QUESTIONTITLE}</p>
                           </div>
                       </div>
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-sm-10">
                               <p class="form-control-static">${resolvedEventDetail.USERNAME}</p>
                           </div>
                       </div>
                       <div class="hr-line-dashed"></div>
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-sm-10">
                               <p class="form-control-static">${resolvedEventDetail.QUESTIONTIME}</p>
                           </div>
                       </div>
                       <div class="hr-line-dashed"></div>
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-sm-10">
                               <p class="form-control-static" >${resolvedEventDetail.FAQANSWER}</p>
                           </div>
                       </div>
                       <div class="hr-line-dashed"></div>
                   ...
                   <div class="ibox-content"  style="display:none;padding-bottom: 50px" id="updateinfo">
                      <form  class="form-horizontal"  action="">
                          <div class="form-group" style="display: none;">
                              <div class="col-sm-10">
                                  <input type="text" name="UserName" class="form-control"  required="required" value="${resolvedEventDetail.USERQUESTIONID}" id="questionId" readonly="readonly">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text"  class="form-control"  aria-required="true"  required="required" value="${resolvedEventDetail.QUESTIONTITLE}" id="title" style="width: 80%;float: left;">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10" id="faqcontent">
                                  ${resolvedEventDetail.FAQANSWER}
                              </div>
                          </div>
                          <div class="hr-line-dashed"></div>    
                      </form>
                      
                      <div class="col-sm-4 col-sm-offset-2" id="${resolvedEventDetail.USERQUESTIONID }">
                           <button class="btn btn-primary" onclick="window.history.back(-1)">返回</button>
